...
tags:
  ...
  - reference
type: reference
source: raw/notes/systems/Mac.md
author: user
---

**Summary:** The user's Mac Studio reference: window-management apps and shortcut keys, SMB mounting in both directions, gaming via Parallels/CrossOver/CloudDeck, display and HDMI quirks, external-drive speed tests, browser notes, and the VeraCrypt password-sync setup.

Related: [[Obsidian]] · [[VSCode]] · [[VLC]] · [[Display-KVM]] · [[AI tools and learning sources]]
...
Window management and multi-tasking recommended from reddit
	...
	- Alt-Tab: https://alt-tab-macos.netlify.app/ -shows the image of the tab 
...
https://clouddeck.app/blog/warhammer-40000-chaos-gate-daemonhunters-mac/
...
- The password/keys section describes a VeraCrypt volume synced to iCloud and OneDrive by script; the scripts themselves aren't recorded here. Worth writing down before they're lost.
- Several display problems (flickering Thunderbolt-to-HDMI, wake-from-sleep failures) are suspected to share one cause; not resolved.
