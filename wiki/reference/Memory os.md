...
tags:
  ...
  - mnemonics
type: reference
source: raw/notes/life/Memory os.md
author: user
---

**Summary:** The user's memory system: the rhyme pegs 1-9, a full 0-100 Major-system person/object list, the worked pi story, and phone numbers encoded as images. Practised at 20:00 in [[Routine]].

Related: [[Memory]] · [[Routine]] · [[Justin Sung]] · [[Jim Kwik]]

**Note:** this page contains the user's own phone number and their father's, encoded and in plain digits, as in the original note.
...
- The two image embeds resolve from `Attachments/`; they presumably show the peg system, but nothing says so.
- Consider whether the phone numbers should live in the wiki at all, or stay only in `raw/`.
