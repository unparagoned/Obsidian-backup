...
- The restart command is `graffiti_api.service`, tying this box to the Graffiti project; note which repo actually deploys here.
- Certificate expiry dates aren't recorded; add them so renewal isn't a surprise.
