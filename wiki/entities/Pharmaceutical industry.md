...
type: entity
kind: organisation
source: raw/notes/health/Pharmaceutical industry.md
author: user
---

#bigpharma

**Summary:** Cases where commercial decisions or misconduct by drug companies shaped the evidence or availability of treatments: J&J abandoning a promising dengue antiviral (mosnodenvir) in 2024 when it left infectious diseases, and GSK's ghostwritten Study 329 on paroxetine in adolescents, which led to a $3bn settlement in 2012.

Related: [[Depression#SSRIs]] · [[Depression]] · [[Paracetamol]] · [[Mounjaro tirzepatide]] · [[Supplement suppliers]] · [[Reddit]]

# Dengue treatment abandoned

News article (Science, 2025) on J&J dropping mosnodenvir.
...
Phase 2 controlled human infection trial (NEJM 2025) of mosnodenvir.
...
Wikipedia article on Study 329 (secondary source; citations to BMJ, DOJ).
...
- Wikipedia citation artifacts `[ [N](url) ]`-style converted to `[N](url)`.
- Cite the BMJ 2015 RIAT reanalysis of Study 329 (Le Noury et al.) directly.
- Add other cases (e.g. Vioxx, oxycodone) if the page is meant to be a catalogue.
