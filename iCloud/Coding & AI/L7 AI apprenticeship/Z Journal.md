...
During testing the secBERT did outperform other models like mpnet and e5 models. While secBERT had the best performance over all other models in testing, to properly train it required GPUs which would be expensive to implement and couldn't run on existing architecture.
