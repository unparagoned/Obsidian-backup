...
Straight paths are the longest path between two events due to hyperbolic geometry (t^2 - x^2). And faster speeds are shorter paths, so they experience less time. 
...
Length contractions can be explained directly from maxwells equations. 

https://www.youtube.com/watch?v=xfjBhQ2lF4I
Let

β=vc,γ=11−β2.β=cv​,γ=1−β2​1​.
...
For the charge configuration used in the cited calculation, force equilibrium gives

db2=bd2(1−β2)3/2,b2d​=d2(1−β2)3/2b​,

where bb is the longitudinal dimension and dd the transverse dimension. Rearranging:

d3(1−β2)3/2=b3,d3(1−β2)3/2=b3,

so

b=d1−β2=dγ.b=d1−β2​=γd​.

That is exactly Lorentz contraction. At v=0.8cv=0.8c, for example,

1−0.82=0.6,1−0.82​=0.6,

so the longitudinal dimension becomes 0.60.6 of the original. **No algebraic trick or obvious maths error there.** The detailed published version reaches the same result and shows it is a necessary and sufficient equilibrium condition for its five-charge model. [Redžić’s calculation](https://arxiv.org/pdf/1501.05899?utm_source=chatgpt.com).
...
- [Miller, “A constructive approach to the special theory of relativity”](https://arxiv.org/abs/0907.0902?utm_source=chatgpt.com)
- [Redžić, “Direct calculation of length contraction and clock retardation”](https://arxiv.org/abs/1501.05899?utm_source=chatgpt.com)
- [A detailed 2025 treatment of Bell’s dynamical route](https://arxiv.org/html/2506.23450v1?utm_source=chatgpt.com)