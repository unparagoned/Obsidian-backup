...
>“Logic being the encircling fence, Ethics the crop, Physics the soil

But ethics means more about how to live a good life   


>We should, for example, strive to become better people—to become virtuous in the ancient sense of the word
...
Zeno — the Founder. A merchant from Cyprus who ended up in Athens and founded Stoicism around 300 BCE. Memory hook: Zeno = Zero, the starting point.
...
The shortest memory chain is: Founder → Mentor -> Adviser → Slave → Emperor.


# Hardship

>Seneca, by the way, argued along similar lines: God, he said, “does not make a spoiled pet of a good man; he tests him, hardens him, and fits him for his own service.”

# Negative visualisation

Think about losing what you have for granted. It will make you appreciate what you have even more. Negative visualisation. 

When you have a glass half full, with negative visualisation, you’d think you are really happy to have a glass at all or even have some water. 
...
>It teaches us, in other words, to enjoy what we have without clinging to it. This in turn means that by practicing negative visualization
...
>someone who has an understanding of Stoic philosophy—will do just the opposite. He will look “for all benefit and harm to come from himself.”
...
Set goals that you can achieve. Like set a goal of playing to the best of your ability, rather than the goal of winning the game. 
...
>We are not chained to feelings and emotions of our base desires since we can reason. 

>Because we can reason, we can not only understand our evolutionary predicament but take conscious steps to escape it, to the extent possible.



>we are evolutionarily programmed to want certain things and to experience certain emotions under certain circumstances; about how living in accordance with our evolutionary programming, although it may have allowed our evolutionary ancestors to survive and reproduce, can result in modern humans living miserable lives; and about how, by “misusing” our reasoning ability, we can overcome our evolutionary programming. I would go on to point out that the Stoics, although they didn’t understand evolution, nevertheless discovered psychological techniques that, if practiced, can help us overcome those aspects of our evolutionary programming that might otherwise disrupt our tranquility.
...
2. They are ignorant, so you can't blame them since it's unintentional
...
Letters to Lucilius, 12, 26, 83 and maybe others, but there are lots 

## Musonius Rufus

The Roman Socrates - maybe hard to get

## Epictetus

Handbook/Manual/Encheiridion
